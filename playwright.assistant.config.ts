...
export default defineConfig({
  ...
  reporter: [["list"], ["html", { open: "never", outputFolder: "playwright-report/assistant" }]],
  outputDir: "test-results/assistant",
  globalSetup: path.resolve(FE_DIR, "tests/e2e/setup/global-setup.assistant.ts"),
  use: {
