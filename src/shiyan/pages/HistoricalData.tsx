...
const HistoricalData: React.FC<Props> = ({ completeStep }) => {
        ...
        <div className="mb-8">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <span className="font-medium text-blue-800">分析产品：云裳服饰 - 真丝连衣裙</span>
            </div>
            <p className="text-blue-700">
              融入传统刺绣元素的真丝连衣裙，价格区间 ¥800-1500，主要面向追求品质和文化内涵的消费者群体。
            </p>
          </div>
        </div>
                    ...
                    <div className="relative group w-full">
                      ...
                      <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 opacity-0 group-hover:opacity-100 transition-opacity bg-gray-900 text-white text-sm rounded-lg px-3 py-2 whitespace-nowrap z-10 shadow-lg">
                        <div className="text-center">
                          ...
                          <div className="text-lg font-bold text-blue-300">{data.sales.toLocaleString()}件</div>
          ...
          <div className="flex items-center justify-between mt-6 pt-6 border-t border-gray-200">
            <div className="flex items-center space-x-8">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-gray-600">高峰期销量 (&gt;{Math.round(avgSales * 1.2)}件)</span>
              </div>
              <div className="flex items-center space-x-2">
            ...
            <div className="flex items-center space-x-8 text-sm">
              <div>
                ...
                <span className="font-bold text-gray-900">{avgSales.toLocaleString()}件</span>
              </div>
              <div>
                <span className="text-gray-600">最高月销量：</span>
                <span className="font-bold text-blue-600">{maxSales.toLocaleString()}件</span>
              </div>
            </div>
          </div>
        </div>
