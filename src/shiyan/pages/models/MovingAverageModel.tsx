...
import { BarChart3, Settings, Play, TrendingUp, CheckCircle, Target, X, History, ArrowRight, ArrowLeft, Info, Calculator, Clock, BarChart } from 'lucide-react';
        ...
        return (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-4">移动平均法</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
                ...
                <h3 className="text-lg font-semibold text-blue-900 mb-3">简单易懂</h3>
              ...
              <div className="bg-green-50 rounded-xl p-6 border border-green-200">
                ...
                <h3 className="text-lg font-semibold text-green-900 mb-3">快速计算</h3>
              ...
              <div className="bg-orange-50 rounded-xl p-6 border border-orange-200">
                ...
                <h3 className="text-lg font-semibold text-orange-900 mb-3">稳定可靠</h3>
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-medium text-gray-800 mb-3">✅ 适合使用</h4>
                ...
                <div>
                  <h4 className="font-medium text-gray-800 mb-3">❌ 不适合使用</h4>
                  <ul className="space-y-2 text-gray-600">
                    <li>• 数据有明显的上升或下降趋势</li>
                    <li>• 存在明显的季节性模式</li>
                    <li>• 需要高精度的长期预测</li>
        ...
        return (
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
              <h3 className="text-2xl font-semibold text-gray-900 mb-6 text-center">简单移动平均公式</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <div className="font-medium text-gray-900">历史观测值</div>
                        <div className="text-sm text-gray-600">过去n个时期的实际销量数据</div>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <div className="font-medium text-gray-900">时间窗口</div>
                        <div className="text-sm text-gray-600">参与计算平均值的历史数据点数量</div>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-600">下一时期的预测销量</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="text-sm text-gray-600 mb-3">假设过去5个月的销量数据：</div>
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        <span>1月：</span><span className="font-mono">1200</span>
                      </div>
                      <div className="flex justify-between">
                        <span>2月：</span><span className="font-mono">1350</span>
                      </div>
                      <div className="flex justify-between">
                        <span>3月：</span><span className="font-mono">1180</span>
                      </div>
                      <div className="flex justify-between">
                        <span>4月：</span><span className="font-mono">1420</span>
                      </div>
                      <div className="flex justify-between">
                        <span>5月：</span><span className="font-mono">1290</span>
                      </div>
                    </div>
                    <div className="border-t border-gray-300 mt-4 pt-4">
                      <div className="text-sm text-gray-600 mb-2">3期移动平均预测6月销量：</div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
              <h4 className="font-semibold text-yellow-800 mb-3">💡 关键要点</h4>
        ...
        return (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-4">时间窗口选取</h2>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-6">窗口大小对比</h3>
                
                <div className="space-y-4">
                  {[
                    { size: 3, desc: '高敏感度', color: 'bg-red-100 text-red-700', pros: '快速响应变化', cons: '容易受噪声影响' },
                    { size: 6, desc: '平衡选择', color: 'bg-yellow-100 text-yellow-700', pros: '平衡性能', cons: '中等响应速度' },
                    { size: 12, desc: '高平滑度', color: 'bg-green-100 text-green-700', pros: '结果稳定', cons: '响应变化慢' }
                  ].map((option) => (
                    <div 
                      key={option.size}
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        <span className="font-semibold text-gray-900">{option.size}个月窗口</span>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
              <h4 className="font-semibold text-blue-800 mb-3">📊 当前配置预览</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h5 className="font-medium text-blue-700 mb-2">选择的参数：</h5>
                  <div className="space-y-1 text-blue-600">
                    <div>时间窗口：{windowSize}个月</div>
                    <div>权重类型：{
                      weightType === 'simple' ? '简单移动平均' : 
                      weightType === 'weighted' ? '加权移动平均' : '指数移动平均'
                    }</div>
                  </div>
                </div>
                <div>
                  ...
                  <div className="text-blue-600 text-sm">
                    {windowSize <= 4 ? '对最新数据变化敏感，适合快速响应市场变化' :
                     windowSize <= 8 ? '平衡的预测效果，既能响应变化又保持稳定' :
                     '平滑的预测结果，适合长期趋势分析'}
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                    ...
                    <span className="font-semibold text-gray-900">{windowSize}个月</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                ...
                <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-blue-700 text-sm">
                    系统将使用最近{windowSize}个月的历史销售数据，
                    通过{weightType === 'simple' ? '简单' : weightType === 'weighted' ? '加权' : '指数'}移动平均法
                    计算未来6个月的需求预测。
                  </p>
                </div>
              </div>
                ...
                {!isCalculating ? (
                  ...
                  <div className="text-center">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-3">
                      <div className="bg-blue-600 h-3 rounded-full animate-pulse" style={{ width: '70%' }}></div>
                    </div>
                    <p className="text-sm text-gray-500 mt-2">请稍候，计算即将完成</p>
                  </div>
                )}
              </div>
            </div>
