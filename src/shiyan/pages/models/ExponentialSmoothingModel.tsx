...
import { TrendingUp, Settings, Play, BarChart, CheckCircle, Target, X, History, ArrowRight, ArrowLeft, Info, Calculator, Sliders, BarChart3 } from 'lucide-react';
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-orange-50 rounded-xl p-6 border border-orange-200">
                ...
                <h3 className="text-lg font-semibold text-orange-900 mb-3">权重递减</h3>
              ...
              <div className="bg-green-50 rounded-xl p-6 border border-green-200">
                ...
                <h3 className="text-lg font-semibold text-green-900 mb-3">快速响应</h3>
              ...
              <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
                ...
                <h3 className="text-lg font-semibold text-blue-900 mb-3">参数可调</h3>
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">与移动平均法的对比</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-medium text-gray-800 mb-3">🔥 指数平滑法优势</h4>
                ...
                <div>
                  <h4 className="font-medium text-gray-800 mb-3">📊 移动平均法特点</h4>
                  <ul className="space-y-2 text-gray-600">
                    <li>• 所有历史数据权重相等</li>
                    <li>• 预测结果更加平滑</li>
                    <li>• 对异常值不敏感</li>
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-xl p-6">
              <h4 className="font-semibold text-orange-800 mb-3">🎯 最佳应用场景</h4>
        ...
        return (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-4">计算公式</h2>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
                <h3 className="text-2xl font-semibold text-gray-900 mb-6 text-center">简单指数平滑公式</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    <h4 className="text-lg font-semibold text-gray-900 mb-4">参数说明</h4>
                    <div className="space-y-4">
                      <div className="flex items-start space-x-3">
                        <div className="w-8 h-8 bg-orange-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                          <span className="text-orange-600 font-bold text-sm">α</span>
                        </div>
                        <div>
                          <div className="font-medium text-gray-900">平滑系数</div>
                          <div className="text-sm text-gray-600">控制对最新观测值的权重，取值0-1</div>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <div className="font-medium text-gray-900">实际观测值</div>
                          <div className="text-sm text-gray-600">当前时期的实际销量数据</div>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <div className="font-medium text-gray-900">平滑值</div>
                          <div className="text-sm text-gray-600">经过平滑处理的预测值</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-900 mb-4">计算示例</h4>
                    <div className="bg-gray-50 rounded-lg p-4">
                      <div className="text-sm text-gray-600 mb-3">假设α=0.3，历史数据：</div>
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          <span>1月实际：</span><span className="font-mono">1200</span>
                        </div>
                        <div className="flex justify-between">
                          <span>1月平滑：</span><span className="font-mono">1200</span>
                        </div>
                        <div className="flex justify-between">
                          <span>2月实际：</span><span className="font-mono">1350</span>
                        </div>
                      </div>
                      <div className="border-t border-gray-300 mt-4 pt-4">
                        <div className="text-sm text-gray-600 mb-2">2月平滑值计算：</div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
              <h4 className="font-semibold text-yellow-800 mb-3">💡 关键理解</h4>
        ...
        return (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-4">平滑系数选择</h2>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-6">参数配置</h3>
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-4">
                      <input 
                        ...
                        className="flex-1"
                      />
                      <span className="text-lg font-semibold text-orange-600 w-8">{alpha}</span>
                    </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-6">权重分布可视化</h3>
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <h4 className="font-medium text-gray-900 mb-3">参数效果对比</h4>
                  <div className="space-y-3">
                    {[
                      { alpha: 0.1, desc: '高平滑度', color: 'bg-blue-100 text-blue-700', effect: '稳定但响应慢' },
                      { alpha: 0.3, desc: '平衡选择', color: 'bg-green-100 text-green-700', effect: '平衡响应和稳定' },
                      { alpha: 0.7, desc: '高敏感度', color: 'bg-red-100 text-red-700', effect: '快速响应但波动大' }
                    ].map((option) => (
                      <div 
                        key={option.alpha}
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <span className="font-semibold text-gray-900">α = {option.alpha}</span>
                          <span className={`px-2 py-1 text-xs rounded-full ${option.color}`}>
                            {option.desc}
                          </span>
                        </div>
                        <div className="text-sm text-gray-600 mt-1">{option.effect}</div>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-xl p-6">
              <h4 className="font-semibold text-purple-800 mb-3">🎯 当前配置预览</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h5 className="font-medium text-purple-700 mb-2">选择的参数：</h5>
                ...
                <div>
                  <h5 className="font-medium text-purple-700 mb-2">预期效果：</h5>
                  <div className="text-purple-600 text-sm">
                    {alpha <= 0.3 ? '平滑的预测结果，对异常值不敏感，适合稳定环境' :
                     alpha <= 0.6 ? '平衡的响应速度，既能跟踪变化又保持稳定' :
                     '快速响应数据变化，适合动态市场环境'}
                  </div>
                </div>
              </div>
      ...
      case 4:
        return (
          <div className="space-y-8">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                    ...
                    <span className="font-semibold text-gray-900">简单指数平滑</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                ...
                <div className="mt-6 p-4 bg-orange-50 rounded-lg">
                  ...
                  <p className="text-orange-700 text-sm">
                    系统将使用简单指数平滑法，
                    基于α={alpha}的平滑系数计算未来6个月的需求预测。
                    {alpha > 0.5 ? '较高的α值将使预测快速响应最新变化。' : '较低的α值将产生更平滑的预测结果。'}
                  </p>
                </div>
              </div>
                ...
                {!isCalculating ? (
                  ...
                  <div className="text-center">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-3">
                      <div className="bg-orange-600 h-3 rounded-full animate-pulse" style={{ width: '75%' }}></div>
                    </div>
                    <p className="text-sm text-gray-500 mt-2">正在应用平滑系数进行计算</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
              <h4 className="font-semibold text-yellow-800 mb-3">🔍 预期结果</h4>
