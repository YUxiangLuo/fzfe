...
import { Brain, Settings, Play, Layers, CheckCircle, Award, X, History } from 'lucide-react';
    ...
    <div className="h-full">
          ...
          <div className="bg-white rounded-2xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between rounded-t-2xl">
              <div className="flex items-center space-x-3">
                ...
                <h2 className="text-xl font-semibold text-green-800">Stacking融合模型训练完成</h2>
              </div>
              <button
            ...
            <div className="p-6 space-y-6">
              <div className="bg-green-50 border border-green-200 rounded-xl p-6">
                <p className="text-green-700">
                  Stacking融合模型训练完成！通过{cvFolds}折交叉验证训练元学习器，
                      ...
                      <div key={index} className="p-3 bg-white rounded-lg">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <div className="flex items-center space-x-2">
                            <div className="text-teal-600 font-semibold">{pred.predicted.toLocaleString()}件</div>
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-teal-50 border border-teal-200 rounded-lg">
                      <div className="flex items-center justify-between mb-2">
                        <h4 className="font-semibold text-teal-800">MAPE (平均绝对百分比误差)</h4>
                        <Award className="w-5 h-5 text-teal-600" />
                      </div>
                      <div className="text-2xl font-bold text-teal-600">{evaluationMetrics.mape}%</div>
                      <p className="text-sm text-teal-700">完美！Stacking达到最优预测精度</p>
                    </div>

                    <div className="grid grid-cols-2 gap-4">
                      <div className="p-3 bg-white rounded-lg">
                        <div className="text-sm text-teal-600">RMSE</div>
                        <div className="text-lg font-bold text-teal-900">{evaluationMetrics.rmse}</div>
                      </div>
                      <div className="p-3 bg-white rounded-lg">
                        <div className="text-sm text-teal-600">R²</div>
                        <div className="text-lg font-bold text-teal-900">{evaluationMetrics.r2}</div>
                      </div>
                    </div>

                    <div className="p-3 bg-yellow-50 rounded-lg">
                      <div className="text-sm text-yellow-600">Stacking配置</div>
                      <div className="grid grid-cols-2 gap-2 text-xs mt-2">
                        <div>元学习器: {metaLearner === 'linear' ? '线性回归' : metaLearner === 'rf' ? '随机森林' : 'XGBoost'}</div>
                        <div>交叉验证: {cvFolds}折</div>
                        <div>特征工程: {useFeatureEngineering ? '启用' : '禁用'}</div>
              ...
              <div className="bg-teal-50 border border-teal-200 rounded-xl p-6">
                <h4 className="font-semibold text-teal-800 mb-3">Stacking融合模型优势分析</h4>
      ...
      <div className="mb-6">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Stacking融合模型</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-2">
                  {[
                    { id: 'linear', name: '线性回归', desc: '简单快速，适合线性组合' },
                    { id: 'rf', name: '随机森林', desc: '处理非线性关系，鲁棒性强' },
                    { id: 'xgb', name: 'XGBoost', desc: '强大的梯度提升，性能最优' }
                  ].map((type) => (
              ...
              <div>
                <label className="flex items-center space-x-3 cursor-pointer">
                  ...
                  />
                  <div>
                    <div className="font-medium text-gray-900">启用特征工程</div>
                    <div className="text-sm text-gray-600">为元学习器生成额外的特征</div>
                  </div>
                </label>
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              <div className="space-y-6">
                {/* 第一层：基础模型 */}
                <div>
                  <div className="text-sm text-gray-600 mb-3">第一层：基础模型</div>
                ...
                {/* 第二层：元学习器 */}
                <div>
                  <div className="text-sm text-gray-600 mb-3">第二层：元学习器</div>
                  <div className="flex justify-center">
                    <div className="text-center">
                      <div className="w-20 h-20 bg-teal-100 rounded-lg flex items-center justify-center mx-auto mb-2">
                        <span className="text-sm font-bold text-teal-600">Meta</span>
                      </div>
                      <div className="text-xs text-gray-600">
                        {metaLearner === 'linear' ? '线性回归' : metaLearner === 'rf' ? '随机森林' : 'XGBoost'}
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="space-y-6 min-h-0">
            ...
            {isTraining && (
              <div className="mt-4 space-y-3">
                ...
                <div className="flex justify-between text-sm text-gray-600">
                  <span>
                    {trainingProgress < 50 ? '训练基础模型' : 
                     trainingProgress < 80 ? '交叉验证' : '训练元学习器'}
                  </span>
          ...
          <div className="bg-teal-50 border border-teal-200 rounded-xl p-6">
            <h3 className="text-lg font-semibold text-teal-800 mb-3">Stacking原理</h3>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {lastPrediction.metaLearner === 'linear' ? '线性回归' : 
                     lastPrediction.metaLearner === 'rf' ? '随机森林' : 'XGBoost'}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">交叉验证:</span>
                  <span className="font-medium">{lastPrediction.cvFolds}折</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">特征工程:</span>
                  <span className="font-medium">{lastPrediction.useFeatureEngineering ? '启用' : '禁用'}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">堆叠层数:</span>
                  <span className="font-medium">{lastPrediction.stackingLayers}</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-4 text-sm">
                <div className="text-center p-2 bg-teal-50 rounded">
                  <div className="font-bold text-teal-600">{lastPrediction.metrics.mape}%</div>
