...
import { Brain, Settings, Play, Database, CheckCircle, Target, X, History, ArrowRight, ArrowLeft, Info, BarChart, Layers, Zap } from 'lucide-react';
...
const LSTMModel: React.FC<Props> = ({ completeStep }) => {
  ...
  const [selectedFeatures, setSelectedFeatures] = useState<string[]>(['sales_quantity']);
  ...
  const availableFeatures = [
    ...
    { id: 'sales_amount', name: '销售金额', description: '历史销售金额数据', required: false },
    { id: 'price', name: '价格', description: '产品价格变化数据', required: false },
    { id: 'date_features', name: '日期特征', description: '月份、季度等时间特征', required: false },
        ...
        return (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-4">LSTM神经网络</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-purple-50 rounded-xl p-6 border border-purple-200">
                ...
                <h3 className="text-lg font-semibold text-purple-900 mb-3">记忆机制</h3>
              ...
              <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
                ...
                <h3 className="text-lg font-semibold text-blue-900 mb-3">长期依赖</h3>
              ...
              <div className="bg-green-50 rounded-xl p-6 border border-green-200">
                ...
                <h3 className="text-lg font-semibold text-green-900 mb-3">高精度预测</h3>
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">LSTM网络结构</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-xl p-6">
              <h4 className="font-semibold text-purple-800 mb-3">🎯 LSTM优势与应用</h4>
        ...
        return (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-4">数据预处理</h2>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-6">标准化方法选择</h3>
                  ...
                  {[
                    {
                      ...
                      pros: ['保持数据分布形状', '适合有明确边界的数据', '计算简单快速'],
                    ...
                    },
                    {
                      ...
                      pros: ['对异常值相对鲁棒', '适合正态分布数据', '无固定范围限制'],
                    ...
                    >
                      ...
                      <div className="bg-gray-50 rounded p-3 mb-3">
                        ...
                        <div className="font-mono text-sm text-gray-900">{method.formula}</div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                        <div>
                          <div className="text-green-600 font-medium mb-1">优点：</div>
                        ...
                        <div>
                          <div className="text-red-600 font-medium mb-1">缺点：</div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-6">数据预处理效果预览</h3>
                
                <div className="space-y-6">
                  <div>
                    <h4 className="font-medium text-gray-800 mb-3">原始数据样本</h4>
                  ...
                  <div>
                    <h4 className="font-medium text-gray-800 mb-3">
                      {normalizationMethod === 'minmax' ? '最小-最大归一化' : 'Z-score标准化'}后
                    </h4>
                        ...
                        {normalizationMethod === 'minmax' ? (
                          <>
                            <div className="text-center">
                              ...
                              <div className="font-bold text-blue-900">0.42</div>
                            </div>
                            <div className="text-center">
                              <div className="text-blue-600">2024-11</div>
                              <div className="font-bold text-blue-900">1.00</div>
                            </div>
                            <div className="text-center">
                              <div className="text-blue-600">2024-12</div>
                              <div className="font-bold text-blue-900">0.18</div>
                            </div>
                          </>
                        ) : (
                          <>
                            <div className="text-center">
                              <div className="text-blue-600">2024-10</div>
                              <div className="font-bold text-blue-900">-0.15</div>
                            </div>
                            <div className="text-center">
                              <div className="text-blue-600">2024-11</div>
                              <div className="font-bold text-blue-900">1.42</div>
                            </div>
                            <div className="text-center">
                              <div className="text-blue-600">2024-12</div>
                              <div className="font-bold text-blue-900">-0.68</div>
                            </div>
                          </>
                        )}
                      </div>
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    <h4 className="font-semibold text-yellow-800 mb-2">当前选择效果</h4>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
              <h4 className="font-semibold text-blue-800 mb-3">💡 数据预处理重要性</h4>
        ...
        return (
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  {availableFeatures.map((feature) => (
                    ...
                    >
                      ...
                      <p className="text-gray-600 text-sm ml-8">{feature.description}</p>
                    </div>
                  ))}
                </div>

                <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                  <h4 className="font-medium text-gray-800 mb-2">已选择特征：{selectedFeatures.length}个</h4>
                  <div className="flex flex-wrap gap-2">
                    {selectedFeatures.map((featureId) => {
                      const feature = availableFeatures.find(f => f.id === featureId);
                      return (
                        <span key={featureId} className="px-2 py-1 bg-green-100 text-green-700 rounded text-sm">
                          {feature?.name}
                        </span>
                      );
                    })}
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-6">网络参数配置</h3>
                ...
                <div className="mt-6 p-4 bg-green-50 rounded-lg">
                  <h4 className="font-medium text-green-800 mb-2">模型配置总结</h4>
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl p-6">
              <h4 className="font-semibold text-green-800 mb-3">🎯 特征选择建议</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-green-700">
                <div>
                  <h5 className="font-medium mb-2">推荐特征组合：</h5>
                  <ul className="list-disc list-inside space-y-1">
                    <li><strong>基础组合</strong>: 销售数量 + 日期特征</li>
                    <li><strong>增强组合</strong>: + 价格 + 促销活动</li>
                    <li><strong>完整组合</strong>: + 销售金额 + 库存水平</li>
                  </ul>
                </div>
                <div>
        ...
        return (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-4">计算结果</h2>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-6">配置总结</h3>
                
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                    <span className="text-gray-600">数据预处理</span>
                    <span className="font-semibold text-gray-900">
                      {normalizationMethod === 'minmax' ? '最小-最大归一化' : 'Z-score标准化'}
                    </span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                    <span className="text-gray-600">输入特征</span>
                    <span className="font-semibold text-gray-900">{selectedFeatures.length}个特征</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                    <span className="text-gray-600">网络结构</span>
                    <span className="font-semibold text-gray-900">{hiddenUnits}单元LSTM</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                    <span className="text-gray-600">时间步长</span>
                    <span className="font-semibold text-gray-900">{timeSteps}个月</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                    <span className="text-gray-600">训练参数</span>
                    <span className="font-semibold text-gray-900">{epochs}轮, lr={learningRate}</span>
                  </div>
                </div>
                ...
                <div className="mt-6 p-4 bg-purple-50 rounded-lg">
                  ...
                  <p className="text-purple-700 text-sm">
                    系统将使用{normalizationMethod === 'minmax' ? '最小-最大归一化' : 'Z-score标准化'}
                    处理{selectedFeatures.length}个输入特征，
                    训练{hiddenUnits}单元的LSTM网络{epochs}轮，
                    预计需要{Math.ceil(epochs / 20)}分钟完成。
                  </p>
                </div>
              </div>

              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-6">开始训练</h3>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
              <h4 className="font-semibold text-yellow-800 mb-3">🔍 训练过程说明</h4>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-6">
              <div className="bg-green-50 border border-green-200 rounded-xl p-6">
                <p className="text-green-700">
                  深度学习模型训练完成！网络已学习到复杂的时间序列模式，
                  使用{selectedFeatures.length}个特征训练了{epochs}轮，
                  以下是高精度预测结果。
                </p>
              </div>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {lastPrediction.normalizationMethod === 'minmax' ? '最小-最大归一化' : 'Z-score标准化'}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">输入特征:</span>
                  <span className="font-medium">{lastPrediction.selectedFeatures.length}个</span>
                </div>
                <div className="flex justify-between">
