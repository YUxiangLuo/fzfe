...
import { TrendingUp, Settings, Play, BarChart, Activity, CheckCircle, Target, X, History, ArrowRight, ArrowLeft, Info, Calculator, Search, Zap } from 'lucide-react';
        ...
        return (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-4">ARIMA模型</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-green-50 rounded-xl p-6 border border-green-200">
                ...
                <h3 className="text-lg font-semibold text-green-900 mb-3">理论扎实</h3>
              ...
              <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
                ...
                <h3 className="text-lg font-semibold text-blue-900 mb-3">置信区间</h3>
              ...
              <div className="bg-purple-50 rounded-xl p-6 border border-purple-200">
                ...
                <h3 className="text-lg font-semibold text-purple-900 mb-3">广泛应用</h3>
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">ARIMA(p,d,q)模型组成</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white rounded-lg p-4">
                  <h4 className="font-medium text-gray-800 mb-3">🔄 AR(p) - 自回归</h4>
                ...
                <div className="bg-white rounded-lg p-4">
                  <h4 className="font-medium text-gray-800 mb-3">📈 I(d) - 差分</h4>
                  <ul className="space-y-2 text-gray-600 text-sm">
                    <li>• 通过d次差分使序列平稳</li>
                    <li>• 消除趋势和季节性</li>
                    <li>• 满足ARIMA建模前提</li>
                ...
                <div className="bg-white rounded-lg p-4">
                  <h4 className="font-medium text-gray-800 mb-3">📊 MA(q) - 移动平均</h4>
                  <ul className="space-y-2 text-gray-600 text-sm">
                    <li>• 当前值与过去q个误差相关</li>
                    <li>• 捕捉随机冲击的影响</li>
                    <li>• 平滑随机波动</li>
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl p-6">
              <h4 className="font-semibold text-green-800 mb-3">🎯 ARIMA建模流程</h4>
        ...
        return (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-4">平稳性检验</h2>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
              <h3 className="text-2xl font-semibold text-gray-900 mb-6 text-center">ADF单位根检验结果</h3>
              
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="bg-red-50 rounded-xl p-6 border border-red-200">
                  <h4 className="text-lg font-semibold text-red-800 mb-4">原始序列检验</h4>
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <span className="text-red-700">ADF统计量</span>
                      <span className="font-mono font-bold text-red-900">-1.245</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-red-700">p值</span>
                      <span className="font-mono font-bold text-red-900">0.652</span>
                    </div>
                    <div className="flex justify-between items-center">
                  ...
                  <div className="mt-4 p-3 bg-red-100 rounded-lg">
                    <div className="text-red-800 font-semibold mb-1">检验结论</div>
                ...
                <div className="bg-green-50 rounded-xl p-6 border border-green-200">
                  <h4 className="text-lg font-semibold text-green-800 mb-4">一阶差分后检验</h4>
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <span className="text-green-700">ADF统计量</span>
                      <span className="font-mono font-bold text-green-900">-4.127</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-green-700">p值</span>
                      <span className="font-mono font-bold text-green-900">0.001</span>
                    </div>
                    <div className="flex justify-between items-center">
                  ...
                  <div className="mt-4 p-3 bg-green-100 rounded-lg">
                    <div className="text-green-800 font-semibold mb-1">检验结论</div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
              <h4 className="font-semibold text-blue-800 mb-3">📊 ADF检验原理</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-blue-700">
                <div>
                  <h5 className="font-medium mb-2">检验假设：</h5>
                  <ul className="space-y-1">
                    <li><strong>H₀</strong>: 序列存在单位根（非平稳）</li>
                    <li><strong>H₁</strong>: 序列不存在单位根（平稳）</li>
                  </ul>
                </div>
                <div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
              <h4 className="font-semibold text-yellow-800 mb-3">💡 检验结果解读</h4>
              <div className="text-yellow-700 text-sm space-y-2">
                <p>• <strong>原始序列</strong>：ADF统计量(-1.245)大于所有临界值，p值(0.652)远大于0.05，表明序列非平稳</p>
                <p>• <strong>一阶差分后</strong>：ADF统计量(-4.127)小于1%临界值(-3.482)，p值(0.001)小于0.01，强烈拒绝原假设</p>
                <p>• <strong>结论</strong>：原始序列为I(1)序列，即一阶单整序列，需要一次差分才能平稳</p>
              </div>
            </div>
          </div>
        );
        ...
        return (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-4">差分阶数选择</h2>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-6">差分阶数配置</h3>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="flex items-center space-x-4">
                      <input 
                        ...
                        className="flex-1"
                      />
                      <span className="text-lg font-semibold text-purple-600 w-8">{dValue}</span>
                    </div>
                  ...
                  <div className="bg-purple-50 rounded-lg p-4">
                    <h4 className="font-medium text-purple-800 mb-2">当前选择效果</h4>
                    <div className="text-purple-700 text-sm">
                      {dValue === 0 && "d=0：不进行差分，适用于已经平稳的序列"}
                      {dValue === 1 && "d=1：一阶差分，消除线性趋势，使序列平稳"}
                      {dValue === 2 && "d=2：二阶差分，消除二次趋势，但可能过度差分"}
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-6">差分效果对比</h3>
                  ...
                  {[
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        <span className="font-semibold text-gray-900">d = {option.d}</span>
                        <span className={`px-2 py-1 text-xs rounded-full border ${option.color}`}>
                          {option.desc}
                        </span>
                      </div>
                      ...
                      <div className="text-xs mt-2">
                        {option.status === 'stationary' && <span className="text-green-600">✓ 平稳</span>}
                        {option.status === 'non-stationary' && <span className="text-red-600">× 非平稳</span>}
                        {option.status === 'over-differenced' && <span className="text-yellow-600">⚠ 可能过度差分</span>}
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl p-6">
              <h4 className="font-semibold text-green-800 mb-3">🎯 差分阶数选择建议</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-green-700">
                ...
                <div>
                  ...
                  <div className="bg-white rounded p-3">
                    <div className="font-semibold text-green-800">推荐 d = 1</div>
        ...
        return (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-4">自动参数寻优计算结果</h2>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-6">参数寻优配置</h3>
                
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                    <span className="text-gray-600">差分阶数 (d)</span>
                    <span className="font-semibold text-gray-900">{dValue}</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                ...
                <div className="mt-6 p-4 bg-indigo-50 rounded-lg">
                  <h4 className="font-medium text-indigo-800 mb-2">自动寻优说明</h4>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-6">开始计算</h3>
                ...
                {!isCalculating ? (
                  ...
                  <div className="text-center">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-3 mb-2">
                      <div className="bg-indigo-600 h-3 rounded-full animate-pulse" style={{ width: '60%' }}></div>
                    </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
              <h4 className="font-semibold text-yellow-800 mb-3">🔍 寻优过程说明</h4>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-3 bg-blue-50 rounded-lg">
                      ...
                      <div className="text-xs text-blue-700">最优模型选择准则</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-xl p-6">
                <h4 className="font-semibold text-green-800 mb-3">ARIMA(2,{dValue},1)模型特点分析</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-green-700">
                  <div>
                    <h5 className="font-medium mb-2">模型组成：</h5>
                    <ul className="list-disc list-inside space-y-1">
                      <li>AR(2): 当前值与前2期值相关</li>
                      <li>I({dValue}): {dValue}阶差分使序列平稳</li>
