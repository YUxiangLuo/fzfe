    ...
    <div className="space-y-6">
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-gray-200 bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-100">
            ...
            {/* Stacking融合模型行 */}
            <tr className="bg-gradient-to-r from-teal-50 to-emerald-50 hover:from-teal-100 hover:to-emerald-100 transition-colors">
      ...
      <div className="p-5 bg-green-50 rounded-lg border border-green-200">
        <p className="text-gray-700 text-base leading-relaxed">
          通过对比各基础模型和Stacking融合模型的评估指标，可以看出Stacking方法通过两层学习器架构，使用元学习器整合多个基础模型的预测结果，通常能获得更稳定和准确的预测性能。
        </p>
      </div>
    </div>
  );
