...
const Results: React.FC<ResultsProps> = ({ data, isLoading, error }) => {
  ...
  return (
    <div>
      <h3 className="text-lg font-semibold mb-4">ARIMA 法 - 预测结果</h3>
      
      <div className="mb-6 p-4 bg-gray-50 rounded-lg border">
        <h4 className="font-semibold">最佳模型参数</h4>
        <p className="text-lg">ARIMA({data.order.p}, {data.order.d}, {data.order.q})</p>
      </div>
