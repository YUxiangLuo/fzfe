...
const ensembleModels: EnsembleModel[] = [
  {
    ...
    implementationNotes: [
      ...
      '内部验证只继承MA窗口、ES α、ARIMA d和LSTM特征/数值缩放方式；ARIMA阶数与LSTM隐藏参数按当前前缀重新推导。',
  ...
  },
  {
    ...
    implementationNotes: [
      ...
      'Level-0只继承MA窗口、ES α、ARIMA d和LSTM特征/数值缩放方式；ARIMA阶数与LSTM隐藏配置按当前前缀重算。',
