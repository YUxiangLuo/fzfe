  ...
  const handleImport = () => {
    ...
    setClasses(prev => prev.map(cls => 
      cls.id === selectedClassForImport
        ? { ...cls, studentCount: cls.studentCount + Math.floor(Math.random() * 30) + 10 }
        : cls
    ));
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">班级编号</th>
      ...
      >
        <div className="space-y-4">
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            <p className="text-sm text-blue-800 font-medium mb-1">文件格式说明：</p>
