...
const formatTooltipNumber = (value: unknown, fractionDigits = 0): string => {
                        ...
                        <div style={{ height: 300 }}>
                            <ResponsiveContainer width="100%" height="100%">
                                <LineChart data={chartData.trendData} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
                                    ...
                                    <RechartsTooltip formatter={(value) => formatTooltipNumber(value, 2)} labelFormatter={(label) => `排名 ${label}`} />
                                    <Legend />
                                    <Line
                                        type="monotone"
                                        dataKey="score"
                            ...
                            <ResponsiveContainer width="100%" height="100%">
                                <RadarChart cx="50%" cy="50%" outerRadius="80%" data={chartData.avgData}>
                                    ...
                                    <Radar
                                        ...
                                        fillOpacity={0.3}
                                    />
                                    <RechartsTooltip formatter={(value) => formatTooltipNumber(value, 2)} />
                                    <Legend />
                                </RadarChart>
                            </ResponsiveContainer>
                        </div>
                                    ...
                                    <ResponsiveContainer width="100%" height="100%">
                                        <BarChart data={barData} layout="vertical" margin={{ top: 5, right: 30, left: 40, bottom: 5 }}>
                                            ...
                                            <RechartsTooltip
                                                ...
                                                formatter={(value) => [`${formatTooltipNumber(value, 2)} 分`, '平均分']}
                                            />
                                    ...
                                    <ResponsiveContainer width="100%" height="100%">
                                        <BarChart data={stackData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                                            ...
                                            <RechartsTooltip
                                                contentStyle={{ borderRadius: 8, border: 'none', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}
                                                cursor={{ fill: 'rgba(255,255,255,0.05)' }}
                                                formatter={(value, name) => [`${formatTooltipNumber(value)} 人`, name]}
                                            />
                                            <Legend />
                                ...
                                {studentCountPieData.length === 0 ? (
                                    ...
                                    <ResponsiveContainer width="100%" height="100%">
                                        <PieChart>
                                            <RechartsTooltip
                                                contentStyle={{ borderRadius: 8, border: 'none', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}
                                                formatter={(value) => `${formatTooltipNumber(value)} 人`}
                                            />
                                            <Pie
