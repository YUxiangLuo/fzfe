...
import type { ExperimentProgress as Progress } from "../../types";
                ...
                <tr key={item.studentId} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center space-x-3">
                      ...
                      <span
                        className={`px-2 py-1 text-xs rounded-full font-medium ${getProgressBgColor(item.progress)} ${
                          item.progress >= 90
                            ? "text-green-800"
                            : item.progress >= 70
                              ? "text-blue-800"
